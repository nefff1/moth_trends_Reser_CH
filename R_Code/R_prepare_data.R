...
# taxonomy used in the analyses, available from the repository
d_std <- read.table("Data/d_taxonomy.txt", header = T)

# sampling details available from the repository (site x year level)
d_samplings <- read.table("Data/d_samplings.txt",
                          header = T)

# nights in which nothing was caught (missing from GBIF data), available from the repository
...
# estimated body mass (species-level), available from the repository
